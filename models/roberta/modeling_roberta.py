...
class RobertaLayer(nn.Module):
    ...
    def forward(
        ...
        if self.training and self.fused_roberta_layer.use_hyclora:
...
class RobertaForSequenceClassification(RobertaPreTrainedModel):
    ...
    #! newly added: set the hyclora-config
    def set_fused_roberta_layer(self, hyclora_config):
        ...
        if layer_type == 'baseline': # no compression
            ...
            fused_roberta_layer_class = FusedRobertaLayerIntraInter
        else:
            raise ValueError("Unsupported type (Available: [FusedRobertaLayerBaseline | FusedRobertaLayerIntra | FusedRobertaLayerIntraInter])")
