...
class ModelArguments:
    ...
    lora_init_type: str = field(
        default="qlora",
        metadata={"help": "LoRA initialization type. [qlora, loftq, pissa, qloftq, qpissa]"},
    )
...
def main():
    ...
    parser = HfArgumentParser(
        (ModelArguments, DataTrainingArguments, TrainingArguments, HyCLoRAArguments)
    )
    ...
    if model_args.lora_init:
        ...
        lora_config = LoraConfig(
            ...
            init_lora_weights=True if model_args.lora_init_type == "qlora" else model_args.lora_init_type
        )
    ...
    # on a small vocab and want a smaller embedding size, remove this validation.
